...
package com.liferay.assignment.registration.service.persistence.impl;
...
import com.liferay.assignment.registration.model.impl.RegisterImpl;
import com.liferay.assignment.registration.model.impl.RegisterModelImpl;
import com.liferay.assignment.registration.service.persistence.RegisterPersistence;
import com.liferay.assignment.registration.service.persistence.impl.constants.RGSPersistenceConstants;
...
public class RegisterPersistenceImpl
	...
	public Register findByUUID_G(String uuid, long groupId)
		...
		Register register = fetchByUUID_G(uuid, groupId);
	...
	public Register fetchByUUID_G(
		...
		if (result instanceof Register) {
			...
			if (!Objects.equals(uuid, register.getUuid()) ||
				(groupId != register.getGroupId())) {
	...
	public Register removeByUUID_G(String uuid, long groupId)
		...
		Register register = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(register.uuid IS NULL OR register.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Register> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Register> findByUuid_C(
	...
	public Register findByUuid_C_First(
		...
		Register register = fetchByUuid_C_First(
	...
	public Register fetchByUuid_C_First(
		...
		List<Register> list = findByUuid_C(
	...
	public Register findByUuid_C_Last(
		...
		Register register = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Register[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, register, uuid, companyId, orderByComparator, true);

			array[1] = register;

			array[2] = getByUuid_C_PrevAndNext(
				session, register, uuid, companyId, orderByComparator, false);
	...
	protected Register getByUuid_C_PrevAndNext(
		Session session, Register register, String uuid, long companyId,
		OrderByComparator<Register> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Register> findByG(long groupId) {
	 ...
	 */
	@Override
	public List<Register> findByG(long groupId, int start, int end) {
	...
	public List<Register> findByG(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Register register : list) {
					if (groupId != register.getGroupId()) {
						list = null;
	...
	public Register findByG_First(
		...
		Register register = fetchByG_First(groupId, orderByComparator);
	...
	public Register fetchByG_First(
		...
		List<Register> list = findByG(groupId, 0, 1, orderByComparator);
	...
	public Register findByG_Last(
		...
		Register register = fetchByG_Last(groupId, orderByComparator);
	...
	public Register[] findByG_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_PrevAndNext(
				session, register, groupId, orderByComparator, true);

			array[1] = register;

			array[2] = getByG_PrevAndNext(
				session, register, groupId, orderByComparator, false);
	...
	protected Register getByG_PrevAndNext(
		Session session, Register register, long groupId,
		OrderByComparator<Register> orderByComparator, boolean previous) {
	...
	public void cacheResult(Register register) {
		...
		finderCache.putResult(
			...
			new Object[] {register.getUuid(), register.getGroupId()}, register);
	}
	...
	protected void cacheUniqueFindersCache(
		RegisterModelImpl registerModelImpl) {

		Object[] args = new Object[] {
			registerModelImpl.getUuid(), registerModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, registerModelImpl, false);
	}
	...
	public Register create(long registerId) {
		...
		register.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Register updateImpl(Register register) {
		...
		if (isNew && (register.getCreateDate() == null)) {
			if (serviceContext == null) {
				register.setCreateDate(now);
			}
			else {
				register.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!registerModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				register.setModifiedDate(now);
			}
			else {
				register.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
		...
		cacheUniqueFindersCache(registerModelImpl);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByG = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByG = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG",
			new String[] {Long.class.getName()}, new String[] {"groupId"},
			true);

		_finderPathCountByG = _createFinderPath(
	...
	@Override
	@Reference(
		target = RGSPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = RGSPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
